...
int main(int argc, char **av) {
  ...
  MMT mmt(&g, /*L*/ 40000,/*T*/ 45, /*time limit*/ 3000, /*pool size*/ 20, /*pgreedy*/0.05, true); // MMTGraph * graph, int L, int T, int time_limit_sec, int pool_size = 99, double pGreedy = 0.5
